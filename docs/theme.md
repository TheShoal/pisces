...
- default agent dir: `~/.pisces/agent`
- effective default file: `~/.pisces/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.pisces/agent/themes/my-theme.json`.
